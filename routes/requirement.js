...
router.delete('/delete/:requirementId',auth.isAuthenticatedJWT, requirementController.deleteRequirementById);
...
router.put('/complete/:requirementId',auth.isAuthenticatedJWT, requirementController.updateRequirementStatusToComplete);
